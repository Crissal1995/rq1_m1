 ...
 * @author brianegge
 */
public class CLI_JUDY_B7_StudentTest extends TestCase {
    ...
    public void testOperators() throws Exception {
        ...
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        PrintWriter pw = new PrintWriter(out);
        options = new Options().addOption("", false, "aaaa aaaa aaaa aaaa aaaa");
        hf.printUsage(pw, 60, "app", options);
        pw.flush();
        assertEquals("simple auto usage", expected, out.toString().trim());
    }
    ...
    public void testNumber1() {
        ...
        options.addOption(new Option("a", "aaa", false, "aaaaaaa"));
        options.addOption(new Option(null, "bbb", false, "bbbbbbb"));
        Option c = new Option("aiojdawidhgawyuidfgauwydtfawdutycdjhgsacdghnasdfatyw", null, true, "ccccccc");
        c.setArgs(3);
        options.addOption(c);
        ...
        PrintWriter pw = new PrintWriter(outBAOS);
        formatter.printHelp(new PrintWriter(out), 80, "foobar", "", options, 3, 2, "");
        assertEquals(
                "usage: foobar\n" +
                        "   -a,--aaa                                                     aaaaaaa\n" +
                        "   -aiojdawidhgawyuidfgauwydtfawdutycdjhgsacdghnasdfatyw <arg>  ccccccc\n" +
                        "      --bbb                                                     bbbbbbb\n"
                , out.toString());
        formatter.printHelp(100, "foobar", "", options, "oke", false);
        assertEquals(
                "usage: foobar\n" +
                        "   -a,--aaa                                                     aaaaaaa\n" +
                        "   -aiojdawidhgawyuidfgauwydtfawdutycdjhgsacdghnasdfatyw <arg>  ccccccc\n" +
                        "      --bbb                                                     bbbbbbb\n"
                , out.toString());
        formatter.printHelp(100, "foobar", "oke", options, "oke", true);
        assertEquals(
                "usage: foobar\n" +
                        "   -a,--aaa                                                     aaaaaaa\n" +
                        "   -aiojdawidhgawyuidfgauwydtfawdutycdjhgsacdghnasdfatyw <arg>  ccccccc\n" +
    ...
    public void testNumber5(){
        ...
        ByteArrayOutputStream outBAOS = new ByteArrayOutputStream();
        PrintWriter pw = new PrintWriter(outBAOS);
        formatter.printWrapped(pw, 100, "ok");
        pw.flush();
        assertEquals(
                "ok\n"
                , outBAOS.toString());
        outBAOS = new ByteArrayOutputStream();
        pw = new PrintWriter(outBAOS);
        formatter.printWrapped(pw, 100,50, "ok");
        pw.flush();
        assertEquals(
                "ok\n"
                , outBAOS.toString());
        outBAOS = new ByteArrayOutputStream();
        pw = new PrintWriter(outBAOS);
        formatter.printOptions(pw, 100, options, 50, 5);
        pw.flush(); assertEquals(
                "                                                  -a,--aaa\n" +
                        " aaaaaaa\n" +
                        "\n" +
                        " -aiojdawidhgawyuidfgauwydtfawdutycdjhgsacdghnasdfatyw <arg>     ccccccc\n" +
    ...
    public void testNumber8() {
        ...
        try{
            formatter.printHelp(null, null, true);
            fail();
        } catch(Exception e){
        ...
        try {
            formatter.printOptions(null, 100, null, 50, 5);
            fail();
        } catch(Exception e){
